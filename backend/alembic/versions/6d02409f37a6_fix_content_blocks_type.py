...
def upgrade() -> None:
    ...
    # Create enum types first (if they don't already exist)
    op.execute("CREATE TYPE messagesender AS ENUM ('USER', 'ASSISTANT')")
    ...
    op.alter_column('chat_messages', 'conversation_id',
               existing_type=sa.UUID(),
               nullable=False)
    # Cast VARCHAR columns to enum types with USING clause
    op.execute("ALTER TABLE chat_messages ALTER COLUMN sender TYPE messagesender USING sender::messagesender")
    ...
    op.alter_column('script_collaborators', 'user_id',
               existing_type=sa.UUID(),
               nullable=False)
    # Cast VARCHAR to collaboratorrole enum
    op.execute("ALTER TABLE script_collaborators ALTER COLUMN role TYPE collaboratorrole USING role::collaboratorrole")
...
def downgrade() -> None:
    ...
    op.alter_column('script_collaborators', 'joined_at',
               ...
               nullable=True,
               existing_server_default=sa.text('now()'))
    # Cast collaboratorrole enum back to VARCHAR
    op.execute("ALTER TABLE script_collaborators ALTER COLUMN role TYPE VARCHAR USING role::text")
    op.alter_column('script_collaborators', 'user_id',
               existing_type=sa.UUID(),
               nullable=True)
    op.alter_column('script_collaborators', 'script_id',
    ...
    op.alter_column('chat_messages', 'metadata',
               ...
               existing_nullable=True,
               existing_server_default=sa.text("'{}'::jsonb"))
    # Cast enum types back to VARCHAR
    op.execute("ALTER TABLE chat_messages ALTER COLUMN role TYPE VARCHAR USING role::text")
    op.execute("ALTER TABLE chat_messages ALTER COLUMN sender TYPE VARCHAR USING sender::text")
    op.alter_column('chat_messages', 'conversation_id',
               existing_type=sa.UUID(),
               nullable=True)
