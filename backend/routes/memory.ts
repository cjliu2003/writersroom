...
router.post('/update', async (req: Request, res: Response) => {
  try {
    const { projectId, slugline, data }: UpdateSceneMemoryRequest = req.body;
    ...
    const updatedScene = MemoryService.updateSceneMemory(projectId, slugline, data);
...
/**
 * GET /api/memory/by-slugline?projectId=xxx&slugline=xxx
 * Get a specific scene by slugline
 */
router.get('/by-slugline', async (req: Request, res: Response) => {
  try {
    ...
    const scene = MemoryService.getSceneBySlugline(projectId as string, slugline as string);
...
/**
 * DELETE /api/memory/scene?projectId=xxx&slugline=xxx
...
router.delete('/scene', async (req: Request, res: Response) => {
  try {
    ...
    const deleted = MemoryService.deleteScene(projectId as string, slugline as string);
