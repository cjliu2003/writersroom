...
exports.ExpectedSceneCounts = exports.TestScenarios = void 0;
exports.generateSRFirstLookScenes = generateSRFirstLookScenes;
exports.verifySceneIntegrity = verifySceneIntegrity;
function generateSRFirstLookScenes(projectId = 'sr_first_look_final') {
    const scenes = [
        {
            projectId,
            sceneIndex: 0,
...
exports.TestScenarios = {
    ...
    invalidScenes() {
        return [
            { sceneIndex: 0 },
            { slugline: 'INT. OFFICE - DAY', sceneId: 'test_1' },
            { slugline: 'INT. OFFICE - DAY', sceneIndex: 2 }
        ];
    },
    nonContiguousScenes() {
        return [
            ...
            { sceneIndex: 3, sceneId: 'test_3', slugline: 'Scene 3' },
            { sceneIndex: 4, sceneId: 'test_4', slugline: 'Scene 4' }
        ];
    },
    largeSceneCollection(count = 1000) {
...
exports.ExpectedSceneCounts = {
    'sr_first_look_final.fdx': 53,
    'test.fdx': 10,
    'seizure-test.fdx': 25,
    'test-silk-road.fdx': 45
};
function verifySceneIntegrity(scenes) {
    const errors = [];
...
//# sourceMappingURL=test-scenes.fixture.js.map